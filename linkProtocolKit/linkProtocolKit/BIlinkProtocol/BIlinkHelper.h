...
/**
 *  跳转app内部页面的标志 格式为key=value
 *
 *  @param appInnerLinkIdentifier default is @"appinner=app"
 */
 ...
 *  跳转app外部的链接标识
 *
 *  @param appBrowserIdentifier default is browser
 */
 ...
 *  app内部网页跳转的标识符号
 *
 *  @param appwebIdentifier default is web
 */
 ...
 *  链接基础url
 *
 *  @param baseURL default is http://www.xxx.com/
 */
